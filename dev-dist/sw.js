...
define(['./workbox-47da91e0'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/opencache\.statkart\.no\/.*/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https:\/\/ws\.geonorge\.no\/.*/i, new workbox.NetworkFirst({
